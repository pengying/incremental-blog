...
#### Authentication
Authentication is usually dependent on you expect your customer to use your API.  It could be a public key, jwt, bearer token, basic auth user and password.
